...
function UploadingCourse({ openCourseLoading, onOpen }) {
  ...
  return (
    <Dialog open={openCourseLoading}>
      <DialogContent className="w-[396px] bg-white">
        <DialogHeader>
          <DialogTitle className="text-center text-[34.31px] font-[600] text-[#303031]">
            Uploading course
          </DialogTitle>
        </DialogHeader>
        ...
        <div className="">
          ...
          />
          <h2 className="text-[22.87px] font-[600] text-[#101828]">
            Software Development with JavaScript and libraries
          </h2>
