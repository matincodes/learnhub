...
import {
  /*Link*/ useLocation /*useRouteContext*/,
...
const NotificationModal = ({ close }) => {
  ...
  return (
    <div
      ...
      className="lg: absolute top-16 sm:block lg:top-14"
    >
      <div onClick={close} className="absolute inset-0 h-full w-full"></div>
      <div
        onClick={e => e.stopPropagation()}
        className="oveflow-y-auto fixed right-[10px] z-[100] h-[100vh] w-[370px] rounded-xl bg-white py-5 lg:right-[15px] lg:max-h-[85%] lg:w-[450px]"
      >
        ...
        <div className="flex w-full items-center justify-between border-b px-3 pb-2">
          <div className="flex items-center gap-x-3">
            ...
            <button
              onClick={() => setActive(2)}
              className={cn(
                'text-[13px] font-[400] text-[#848484]',
                active == 2 && 'text-normal_yellow',
              )}
            >
              Unread({unreadNotifications})
            </button>
          </div>
          <button className="text-[13px] font-[500] text-[#848484]">
            Clear All
          </button>
        </div>
          ...
          {unreadNotifications <= 0 && active === 2 ? (
            <div className="flex h-full w-full flex-col items-center justify-center">
              <img
                ...
                className="w-[150px]"
              />
              <h1 className="font-inter text-[17px] font-[700] text-[#303031]">
